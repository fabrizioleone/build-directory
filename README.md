...
In order to install the package, open the terminal and type

```sh
$ pip install build_directory
```
To make sure that you have the latest realease, type

```sh
$ pip install build_directory --upgrade
```
